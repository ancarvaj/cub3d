...
/*   Updated: 2025/02/23 17:41:33 by ancarvaj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				**ft_strdup_double(char **s, char *_new);
...
int					ft_check_file(char **s, char **texture_files);
enum e_identifier	ft_get_identifier(const char *line);
int					ft_check_map(char **map);
int					get_position(char **map, int *x, int *y);
...
void				ft_up_player(t_cub3d *data, const double moveSpeed);
void				ft_down_player(t_cub3d *data, const double moveSpeed);
void				ft_right_player(t_cub3d *data, const double rotSpeed);
void				ft_left_player(t_cub3d *data, const double rotSpeed);
void				my_mlx_pixel_put(t_mlx *mlx, int x, int y, int color);
void				print_floor_ceiling(t_cub3d *data, int color_floor,
						int color_ceiling);
